...
export const QueryValidationMiddleware = (
  ...
  return async (req: Request, res: Response, next: NextFunction) => {
    try {
      // Explicitly type queryDto
      const queryDto: Record<string, any> = plainToInstance(type, req.query);
      ...
      next(
        new BadRequestError(ErrorCode.BODY_DYNAMİC_ERROR, translatedErrors, [
          {
            logCode: ErrorCode.BODY_DYNAMİC_ERROR,
